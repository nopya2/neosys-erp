            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right">Telephone</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ old('role') }}" required>
                                    ...
                                    <option value="gestionnaire_clients">Gestion de clients</option>
                                    <option value="admin_compte_client">Administrateur du compte</option>
                                    <option value="utilisateur_client">Utilisateur</option>
                                </select>
                        ...
                        <div class="form-group row">
                            <label for="entreprise" class="col-md-4 col-form-label text-md-right">Entreprise</label>

                            <div class="col-md-6">
                                <select id="entreprise" class="form-control @error('entreprise') is-invalid @enderror" name="entreprise" value="{{ old('entreprise') }}" required>
                                    <option value="1">Neosys Technologie</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="departement" class="form-control @error('departement') is-invalid @enderror" name="departement" value="{{ old('departement') }}" required>
