...
<div style="font-size: 11px; border: 1px solid red; width: 390px; margin-top: -112px; padding: 5px">
    Paiement à réception de la facture.  Merci de nous renvoyer ce document par email à {{ $information->email }}<br>
    Vous disposez d'un délai de rétractation de {{ $information->purchase_order_delay }} jours.
</div>

<div style="margin: 80px 0 0 140px; text-align: center">
    <p>Bon pour accord avec mention manuscrite "Lu et approuvé"</p>
    <p style="margin: 80px 0 0 0">(Date, signature et cachet de la société)</p>
</div>
