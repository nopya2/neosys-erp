...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('theme/datta-able/assets/fonts/fontawesome/css/fontawesome-all.min.css') }}">

    <link rel="stylesheet" href="{{ asset('theme/datta-able/assets/plugins/animation/css/animate.min.css') }}">

    <link rel="stylesheet" href="{{ asset('theme/datta-able/assets/plugins/notification/css/notification.min.css') }}">

    <link rel="stylesheet" href="{{ asset('theme/datta-able/assets/css/style.css') }}">
</head>
<body>
...
page</span></a></li>
                ...
                <li data-username="Need Support" class="nav-item"><a href="../../../../codedthemes.support-hub.io/index.html" class="nav-link" target="_blank"><span class="pcoded-micon"><i class="feather icon-help-circle"></i></span><span class="pcoded-mtext">Need
support ?</span></a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ asset('theme/datta-able/assets/images/user/avatar-1.jpg') }}" alt="Generic placeholder image">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ asset('theme/datta-able//assets/images/user/avatar-2.jpg') }}" alt="Generic placeholder image">
                                    <div class="media-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ asset('theme/datta-able/assets/images/user/avatar-3.jpg') }}" alt="Generic placeholder image">
                                    <div class="media-body">
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{ asset('theme/datta-able/assets/images/user/avatar-1.jpg') }}" class="img-radius" alt="User-Profile-Image">
                            <span>John Doe</span>
        ...
        <div class="main-friend-cont scroll-div">
            <div class="main-friend-list">
                <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe">
                    <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('theme/datta-able/assets/images/user/avatar-1.jpg') }}" alt="Generic placeholder image ">
                ...
                <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe">
                    <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('theme/datta-able//assets/images/user/avatar-2.jpg') }}" alt="Generic placeholder image">
                ...
                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice">
                    <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('theme/datta-able/assets/images/user/avatar-3.jpg') }}" alt="Generic placeholder image"></a>
                    <div class="media-body">
                ...
                <div class="media userlist-box" data-id="5" data-status="offline" data-username="Suzen">
                    <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('theme/datta-able/assets/images/user/avatar-4.jpg') }}" alt="Generic placeholder image"></a>
                    <div class="media-body">
        ...
        <div class="main-chat-cont scroll-div">
            <div class="main-friend-chat">
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="{{ asset('theme/datta-able//assets/images/user/avatar-2.jpg') }}" alt="Generic placeholder image"></a>
                                    ...
                                    <div class="card-block px-0 py-3">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                <tbody>
                                                <tr class="unread">
                                                    <td><img class="rounded-circle" style="width:40px;" src="{{ asset('theme/datta-able/assets/images/user/avatar-1.jpg') }}" alt="activity-user"></td>
                                                    <td>
                                                ...
                                                <tr class="unread">
                                                    <td><img class="rounded-circle" style="width:40px;" src="{{ asset('theme/datta-able//assets/images/user/avatar-2.jpg') }}" alt="activity-user"></td>
                                                    <td>
                                                ...
                                                <tr class="unread">
                                                    <td><img class="rounded-circle" style="width:40px;" src="{{ asset('theme/datta-able/assets/images/user/avatar-3.jpg') }}" alt="activity-user"></td>
                                                    <td>
...
<script src="{{ asset('theme/datta-able/assets/js/vendor-all.min.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/js/menu-setting.min.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/js/pcoded.min.js') }}"></script>

<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/amcharts.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/gauge.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/serial.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/light.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/pie.min.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/ammap.min.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/usaLow.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/radar.js') }}"></script>
<script src="{{ asset('theme/datta-able/assets/plugins/amchart/js/worldLow.js') }}"></script>

<script src="{{ asset('theme/datta-able/assets/plugins/notification/js/bootstrap-growl.min.js') }}"></script>

<script src="{{ asset('theme/datta-able/assets/js/pages/dashboard-custom.js') }}"></script>
</body>
</html>
