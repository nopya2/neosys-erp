<template>
    <form method="POST" :action="`/customer/${id}/edit`">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="company_name" placeholder="Nom de l'entreprise" v-model.lazy="$v.customer.company_name.$model" name="company_name">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="phonenumber" placeholder="" v-model.trim="$v.customer.phonenumber.$model" name="phonenumber">
                <small class="form-text text-danger" v-if="!$v.customer.phonenumber.required">Champs requis.</small>
            </div>
            <div class="form-group col-md-6">
                <label for="email">E-mail <span class="text-danger">(*)</span></label>
                <input type="email" class="form-control" id="email" placeholder="E-mail" v-model.lazy="$v.customer.email.$model" name="email">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select id="city" class="form-control" v-model.trim="$v.customer.city.$model" name="city">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select id="activity" class="form-control" v-model.trim="$v.customer.activity.$model" name="activity">
            ...
            <div class="form-group col-md-6">
                ...
                <textarea id="address" class="form-control" v-model.trim="$v.customer.address.$model" name="address"></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="bp" placeholder="" v-model.trim="$v.customer.bp.$model" name="bp">
            </div>
            <div class="form-group col-md-6">
                <label for="website">Site web</label>
                <input type="text" class="form-control" id="website" placeholder="" v-model.trim="$v.customer.website.$model" name="website">
            </div>
        </div>
    ...
    export default {
            ...
            customer: {
                ...
                company_name: {
                    ...
                    async isUnique (value) {
                        ...
                        const response = await fetch(`/api/customer/unique-name/${value}?api_token=${this.api_token}&id=${this.customer_id}`)
                ...
                email: {
                    ...
                    async isUnique (value) {
                        if (value === '') return true
                        const response = await fetch(`/api/customer/unique-email/${value}?api_token=${this.api_token}&id=${this.customer_id}`)
                        return Boolean(await response.json())
                    }
                },
                address: {
        ...
        methods: {
            fetchCustomer(page_url) {
                ...
                page_url = page_url || `/api/customer/${this.customer_id}?api_token=${this.api_token}`
                fetch(page_url)
                    .then(res => res.json())
                    .then(res => {
